    ...
    def update(self):
        ...
        if keys[pygame.K_UP]:
            if MapPart1 == True or MapPart2 == True:
                ...
                if (not((collisions["house1"][0] < XNat < collisions["house1"][1]) and (collisions["house1"][2] < YNat < collisions["house1"][3]+10))) and (not((collisions["house2"][0] < XNat < collisions["house2"][1]) and (collisions["house2"][2] < YNat < collisions["house2"][3]+9))) and (not((collisions["bushligne"][0] < XNat < collisions["bushligne"][1]) and (collisions["bushligne"][2] < YNat < collisions["bushligne"][3]+9))) and (not((collisions["barriere1"][0] < XNat < collisions["barriere1"][1]) and (collisions["barriere1"][2] < YNat < collisions["barriere1"][3]+6))) and (not((collisions["barriere2"][0] < XNat < collisions["barriere2"][1]) and (collisions["barriere2"][2] < YNat < collisions["barriere2"][3]+9))) and (not((collisions["barriere3"][0] < XNat < collisions["barriere3"][1]) and (collisions["barriere3"][2] < YNat < collisions["barriere3"][3]+9))):
                    YNat -= vitesse

            elif MapPart4 == True:
                if not((collisions["barriere4"][0] < XNat < collisions["barriere4"][1]) and (collisions["barriere4"][2] < YNat < collisions["barriere4"][3]+10)):
                    YNat -= vitesse
    ...
    def update(self):
        ...
        if keys[pygame.K_DOWN]:
            if MapPart5 == True or MapPart6 == True:
                ...
                if (not((collisions["house1"][0] < XNat < collisions["house1"][1]) and (collisions["house1"][2]-10 < YNat < collisions["house1"][3]))) and (not((collisions["house2"][0] < XNat < collisions["house2"][1]) and (collisions["house2"][2] < YNat < collisions["house2"][3]))) and (not((collisions["bushligne"][0] < XNat < collisions["bushligne"][1]) and (collisions["bushligne"][2]-10 < YNat < collisions["bushligne"][3]))) and (not((collisions["barriere1"][0] < XNat < collisions["barriere1"][1]) and (collisions["barriere1"][2] < YNat < collisions["barriere1"][3]))) and (not((collisions["barriere2"][0] < XNat < collisions["barriere2"][1]) and (collisions["barriere2"][2]-5 < YNat < collisions["barriere2"][3]))) and (not((collisions["barriere3"][0] < XNat < collisions["barriere3"][1]) and (collisions["barriere3"][2]-5 < YNat < collisions["barriere3"][3]))):
                    YNat += vitesse

            elif MapPart4 == True:
                if not((collisions["barriere4"][0] < XNat < collisions["barriere4"][1]) and (collisions["barriere4"][2]-9 < YNat < collisions["barriere4"][3])):
                    YNat += vitesse
    ...
    def update(self):
        ...
        if keys[pygame.K_RIGHT]:
            if MapPart2 == True or MapPart6 == True:
                ...
                if (not((collisions["house1"][0]-10 < XNat < collisions["house1"][1]) and (collisions["house1"][2] < YNat < collisions["house1"][3]))) and (not((collisions["house2"][0]-10 < XNat < collisions["house2"][1]) and (collisions["house2"][2] < YNat < collisions["house2"][3]))) and (not((screenwidth-vitesse-20 < XNat) and (25-vitesse < YNat < 362+vitesse))) and (not((collisions["bushligne"][0]-10 < XNat < collisions["bushligne"][1]) and (collisions["bushligne"][2] < YNat < collisions["bushligne"][3]))) and (not((collisions["barriere1"][0]-10 < XNat < collisions["barriere1"][1]) and (collisions["barriere1"][2] < YNat < collisions["barriere1"][3]))) and (not((collisions["barriere2"][0]-5 < XNat < collisions["barriere2"][1]) and (collisions["barriere2"][2] < YNat < collisions["barriere2"][3]))) and (not((collisions["barriere3"][0]-5 < XNat < collisions["barriere3"][1]) and (collisions["barriere3"][2] < YNat < collisions["barriere3"][3]))):
                    XNat += vitesse

            elif MapPart4 == True:
                if (XNat < screenwidth - vitesse - 50) and (not((collisions["barriere4"][0] < XNat < collisions["barriere4"][1]) and (collisions["barriere4"][2] < YNat < collisions["barriere4"][3]))):
                    XNat += vitesse
    ...
    def update(self):
        ...
        if keys[pygame.K_LEFT]:
            if MapPart1 == True or MapPart5 == True:
                ...
                if XNat > vitesse + 50 and (not((collisions["house1"][0] < XNat < collisions["house1"][1]+5) and (collisions["house1"][2] < YNat < collisions["house1"][3]))) and (not((collisions["house2"][0] < XNat < collisions["house2"][1]) and (collisions["house2"][2] < YNat < collisions["house2"][3]))) and (not((collisions["bushligne"][0] < XNat < collisions["bushligne"][1]) and (collisions["bushligne"][2] < YNat < collisions["bushligne"][3]))) and (not((collisions["barriere1"][0] < XNat < collisions["barriere1"][1]+10) and (collisions["barriere1"][2] < YNat < collisions["barriere1"][3]))) and (not((collisions["barriere2"][0] < XNat < collisions["barriere2"][1]+10) and (collisions["barriere2"][2] < YNat < collisions["barriere2"][3]))) and (not((collisions["barriere3"][0] < XNat < collisions["barriere3"][1]) and (collisions["barriere3"][2] < YNat < collisions["barriere3"][3]))):
                    XNat -= vitesse

            elif MapPart4 == True:
                if not((collisions["barriere4"][0] < XNat < collisions["barriere4"][1]+9) and (collisions["barriere4"][2] < YNat < collisions["barriere4"][3])):
                    XNat -= vitesse
