...
while running:
        ...
        if attack == False and deathallie == False:
            if SacButtonX <= mouse[0] <= SacButtonX+widthB and SacButtonY <= mouse[1] <= SacButtonY+heightB:
                if click[0] == 1:          
                    ...
                    with open("ValueBarwidth.py",'w',encoding = 'utf-8') as fb:
                       fb.write("barwidth = ")
                    ...
                    import ValueBarwidthUpdate
                    
                    barwitdh = ValueBarwidthUpdate.barwidthUpdate
    ...
    if attack == True and deathennemy == False:
        ...
        if miss == False and current_tour <= 20:
            Tour2()
        if missennemi == True and 20 < current_tour < 35:
            txtmissennemi()
